...
export function registerBrowseTools(server: McpServer, browser: BrowserManager): void {
  server.tool(
    "social_screenshot",
    "Take a screenshot of any social media page or website. Supports scrolling to reveal content and animations.",
    {
  ...
  server.tool(
    "social_scroll_capture",
    "Scroll through a page and capture a sequence of screenshots to study scroll animations, parallax effects, and motion design.",
    {
      url: z
        .string()
        .min(1)
  ...
  server.tool(
    "social_get_source",
    "Fetch the full page source of any social page or website, including animation and transition CSS extracted from stylesheets. Use this to study how scroll animations and video effects are built.",
    {
